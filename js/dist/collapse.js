/*!
  * Bootstrap collapse.js v4.3.1 (https://themesberg.com/)
...
(function (global, factory) {
  ...
  var Collapse = /*#__PURE__*/function () {
    function Collapse(element, config) {
      ...
      this._triggerArray = makeArray(SelectorEngine.find(Selector.DATA_TOGGLE + "[href=\"#" + element.id + "\"]," + (Selector.DATA_TOGGLE + "[data-target=\"#" + element.id + "\"]")));
    ...
    _proto._getParent = function _getParent() {
      ...
      var selector = Selector.DATA_TOGGLE + "[data-parent=\"" + parent + "\"]";
