/*!
  * Bootstrap button.js v4.3.1 (https://themesberg.com/)
      ...
      if (rootElement) {
        ...
        if (input && input.type === 'radio') {
          ...
          if (triggerChangeEvent) {
            if (input.hasAttribute('disabled') || rootElement.hasAttribute('disabled') || input.classList.contains(ClassName.DISABLED) || rootElement.classList.contains(ClassName.DISABLED)) {
              return;
            }
