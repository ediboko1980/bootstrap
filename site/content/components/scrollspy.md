...
<div class="bd-example">
  <nav id="navbar-example2" class="navbar navbar-light bg-soft px-3">
...
<div class="bd-example">
  <div class="row">
    <div class="col-4">
      <nav id="navbar-example3" class="navbar navbar-light bg-soft flex-column">
        <a class="navbar-brand" href="#">Navbar</a>
...
{{< highlight html >}}
<nav id="navbar-example3" class="navbar navbar-light bg-soft">
  <a class="navbar-brand" href="#">Navbar</a>
  <nav class="nav nav-pills flex-column">
    <a class="nav-link" href="#item-1">Item 1</a>
    <nav class="nav nav-pills flex-column">
